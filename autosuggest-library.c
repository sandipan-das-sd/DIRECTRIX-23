...
struct library {
	...
	char password[20];
	 ...
	 printf("\t\t\t###########################################################################");
    printf("\n\t\t\t############                                                  ############");
    printf("\n\t\t\t############  Digital Cum Autometic  Library management System Project in C");
    printf("\n\t\t\t############                                                   ############");
    printf("\n\t\t\t###########################################################################");
    printf("\n\t\t\t---------------------------------------------------------------------------\n");
...
scanf("%s",&password);
if(strcmp(userid,"LMS")==0){
	if(strcmp(password,"1234")==0){
		printf("\n\nLogin.... Successful\n\n");
		printf("Welcome to FIEM DIGITAL CUM AUTOMETIC LIBRARY\n\n");
	}
}
else{
	printf("Password Mismatched!!!!\n");
	printf("Please check again or Contact administrator\n");
	exit(0);
}
...
struct library l[100];
    ...
    if(usernumber == 1){
        ...
        printf("Coded By Team Innovatus\n");
        printf("------------------------------------------------------------\n");
        fclose(fptr);
        fclose(file);
        exit(0);
